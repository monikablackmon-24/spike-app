...
import type { VideoCategory, SkillLevel } from '@/types'
...
export default function VideosPage() {
  ...
  return (
    <div className="p-4 md:p-6 max-w-5xl mx-auto">
      <h1 className="text-xl font-black mb-4">Video Library 🎬</h1>
      ...
      <div className="flex gap-2 mb-3 flex-wrap">
        {(['All', ...LEVELS] as const).map(l => (
          <button
            ...
            style={{
              background: level === l ? 'var(--gold)' : 'var(--surface)',
              color: level === l ? '#000' : 'inherit',
            }}
          >
            {l}
          </button>
